...
from pyc8y.auth import parse_auth, BearerAuth, BasicAuth
from pyc8y.api import CumulocityApi
from pyc8y.base import Auth, CumulocityRestApi
...
class _CumulocityAppBase(ABC):
    ...
    @abstractmethod
    def _build_user_instance(self, auth: Auth) -> CumulocityApi:
