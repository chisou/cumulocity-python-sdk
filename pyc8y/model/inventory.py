...
from pyc8y.model.base import CumulocityObject, json_property, time_property, datetime_property, assert_c8y, assert_id, \
    tag_property, CumulocityResource, map_params
...
class Inventory(CumulocityResource[ManagedObject]):
    object_type = ManagedObject
    collection_name = "managedObjects"
    resource_path = "/inventory/managedObjects"
    mime_type = "application/vnd.com.nsn.cumulocity.managedobject+json"
...
class DeviceInventory(Inventory):
    ...
    async def select(
            ...
            **kwargs) -> AsyncGenerator[ManagedObject, None]:
